...
mysample<-sample(airline_safety, size=15, replace = TRUE)
...
# Some of the other packages are stringr and forcats
...
mysample2<-mysample
arrange(mysample2, airline_safety)
...
incidents_00_14<-subset(mysample < 15)
